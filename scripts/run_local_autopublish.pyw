...
def main() -> int:
    ...
    push_dashboard(workbook_path=workbook_path, workbook_url=None, output_path=SCRIPT_DIR.parent / "dashboard_data.json", commit_message="Refresh Chipunza dashboard data")
    return 0
